...
var (
	nresults = flag.Float64("n", 100, "Maximum results (up to 100)")
	since    = flag.String("d", "", "Search since this date (YYYY-MM-DD)")
)

const (
	queryURI = "http://search.twitter.com/search.atom?q=%s&since=%s&rpp=%.1f"
...
func ts(s string, date string, n float64) {
...
func tgrid(t Feed, x, y, w, h, nc float64) {
